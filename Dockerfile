# ============================================
# Multi-stage Dockerfile for Pick Execution Service
...
LABEL org.opencontainers.image.title="Pick Execution Service" \
      org.opencontainers.image.description="TSP path optimization and pick execution service" \
      org.opencontainers.image.version="${APP_VERSION}" \
      org.opencontainers.image.vendor="Paklog" \
      org.opencontainers.image.authors="Paklog Engineering Team" \
      org.opencontainers.image.source="https://github.com/paklog/pick-execution-service" \
